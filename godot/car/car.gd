...
## This function bubbles the signal of the flip detection node up
func _on_flip_detection_flipped(direction: StringName, count: int):
	flipped.emit(direction, count)
